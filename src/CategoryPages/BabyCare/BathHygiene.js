...
function BathHygiene() {
  const {
    state: { FruitsVegetablesProduct },
    
  } = CartState();
  const OnlyBabyCare =  (product) => product.category === 'BabyCare'  && product.subcategory ==='BathHygiene';
  return (
    <div>
    <h2 className="text-center display-4 mt-4 fw-bold">Baby Care Hygiene</h2>
