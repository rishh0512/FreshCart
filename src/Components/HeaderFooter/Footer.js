...
import Logo from "../../Assests/Logo/FooterFreshCartLogo.png";
        ...
        <footer class="py-5">
          <div class="row row-cols-2 row-cols-md-4 text-white">
            <div className="d-flex align-items-center">
              <img src={Logo} alt="" className="w-50 h-7p0" />
            </div>
            <div class="">
              <h4>About</h4>
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-white">
                    ...
                    <span>Fresh Cart Office</span>
                  </a>
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-white">
                    <i className="bi bi-envelope-at me-2"></i>
                    <span>freshcartcontact@gmail.com</span>
                  </a>
                </li>
              </ul>
            </div>
